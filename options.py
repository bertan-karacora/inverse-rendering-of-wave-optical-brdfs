...
parser.add_argument("--reference", type=str, help="Reference heightfield path.")
parser.add_argument("--hypothesis", type=str, help="Hypothesis heightfield path.")
...
parser.add_argument("--diff_model", type=str, default="OHS", choices=["OHS", "GHS", "ROHS", "RGHS", "Kirchhoff"], help="Diffraction model. Expect only subtle difference.")
